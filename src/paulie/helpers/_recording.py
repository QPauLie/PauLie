"""
    ...
    These are plain data containers. They are populated by
    :class:`~paulie.classifier.recording_canonicalizer.FrameRecorder` (a subscriber to the
    canonicalizer events) and consumed by :func:`paulie.helpers.drawing._animation_graph` to
    render an animation.
"""
from typing import cast

import numpy as np
from paulie.common.get_graph import get_graph, GraphWithLabels
...
class FrameRecord:
    ...
    """
    def __init__(self, graph:FrameGraph | None=None, lighting:PauliString | None=None,
                 appending:PauliString | None=None,  contracting:PauliString | None=None,
                 lits:list[PauliString] | None=None, p:PauliString | None=None,
                 q:PauliString | None=None, removing_vertices:list[PauliString] | None=None,
                 replacing_vertices:list[PauliString] | None=None,
                 dependent:PauliString | None=None,
                 title:str | None=None, init:bool=False) -> None:
        """
    ...
    def get_graph(self
    ) -> tuple[list[str], list[tuple[str, str]], dict[tuple[str, str], str] | None] | None:
        """
    ...
    def is_appending(self) -> bool:
        """
        Check if no vertex is being appended to the graph.
    ...
    def is_removing(self) -> bool:
        """
        Check if no vertices are being removed.

        Returns:
            bool: True if no vertices are being removed.
        """
...
class RecordGraph:
    ...
    def append(self, graph: FrameGraph | None=None,
               lighting:PauliString | None=None, appending:PauliString | None=None,
               contracting:PauliString | None=None, lits:list[PauliString] | None=None,
               p:PauliString | None=None, q:PauliString | None=None,
               removing_vertices:list[PauliString] | None=None,
               replacing_vertices:list[PauliString] | None=None,
               dependent:PauliString | None=None, title:str | None=None,
    ...
    def get_graph(self, index:int
        ...
        If the frame at ``index`` has no graph data, walk back to the most recent frame that does.
...
def recording_graph(record:RecordGraph, collection:list[PauliString] | None=None,
                    lighting:PauliString | None=None, appending:PauliString | None=None,
                    contracting:PauliString | None=None, lits:list[PauliString] | None=None,
                    p:PauliString | None=None, q:PauliString | None = None,
                    removing_vertices:list[PauliString] | None=None,
    ...
    Args:
        ...
        collection (list[PauliString], optional): List of vertices. When provided, the
            anticommutation graph of these vertices is stored in the frame.
        lighting (PauliString, optional): Vertex to be added which is generating the lighting.
        appending (PauliString, optional): Vertex to which the new vertex will be attached.
        contracting (PauliString, optional): Vertex which is being contracted.
        lits (list[PauliString], optional): List of lit vertices.
    ...
    if collection is not None:
        vertices, edges, edge_labels = cast(GraphWithLabels, get_graph(collection))
