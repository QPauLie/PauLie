...
def average_graph_complexity(generators: PauliStringCollection, p: PauliString):
    """
    Get the average graph complexity of a Pauli string with respect to the evolution
    generated by a given generator set.

    Args:
        generators: Generating set of the time evolution.
        p: Pauli string to compute the average graph complexity of.
    Returns:
        Average graph complexity of a Pauli string w.r.t an evolution
        generated by a given generator set.
