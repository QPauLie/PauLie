...
In :cite:t:`Aguilar_2024`, an efficient algorithm for classifying which Lie algebra is generated is given.
...
For any generator set consisting of Paulistrings, the anticommutation graph can be transformed to four canonical types (Theorem 1 in :cite:t:`Aguilar_2024` ).
...
according to Theorem 2 in :cite:t:`Aguilar_2024` , it corresponds to :math:`\mathfrak{so}(3)`.
